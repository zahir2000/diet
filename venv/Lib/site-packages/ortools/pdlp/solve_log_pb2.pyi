...
class QuadraticProgramStats(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        num_constraints: typing.Optional[builtins.int] = ...,
        constraint_matrix_col_min_l_inf_norm: typing.Optional[builtins.float] = ...,
        constraint_matrix_row_min_l_inf_norm: typing.Optional[builtins.float] = ...,
        constraint_matrix_num_nonzeros: typing.Optional[builtins.int] = ...,
        constraint_matrix_abs_max: typing.Optional[builtins.float] = ...,
        constraint_matrix_abs_min: typing.Optional[builtins.float] = ...,
        constraint_matrix_abs_avg: typing.Optional[builtins.float] = ...,
        combined_bounds_max: typing.Optional[builtins.float] = ...,
        combined_bounds_min: typing.Optional[builtins.float] = ...,
        combined_bounds_avg: typing.Optional[builtins.float] = ...,
        combined_bounds_l2_norm: typing.Optional[builtins.float] = ...,
        variable_bound_gaps_num_finite: typing.Optional[builtins.int] = ...,
        variable_bound_gaps_max: typing.Optional[builtins.float] = ...,
        variable_bound_gaps_min: typing.Optional[builtins.float] = ...,
        variable_bound_gaps_avg: typing.Optional[builtins.float] = ...,
        objective_vector_abs_max: typing.Optional[builtins.float] = ...,
        objective_vector_abs_min: typing.Optional[builtins.float] = ...,
        objective_vector_abs_avg: typing.Optional[builtins.float] = ...,
        objective_vector_l2_norm: typing.Optional[builtins.float] = ...,
        objective_matrix_num_nonzeros: typing.Optional[builtins.int] = ...,
        objective_matrix_abs_max: typing.Optional[builtins.float] = ...,
        objective_matrix_abs_min: typing.Optional[builtins.float] = ...,
        objective_matrix_abs_avg: typing.Optional[builtins.float] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["combined_bounds_avg",b"combined_bounds_avg","combined_bounds_l2_norm",b"combined_bounds_l2_norm","combined_bounds_max",b"combined_bounds_max","combined_bounds_min",b"combined_bounds_min","constraint_matrix_abs_avg",b"constraint_matrix_abs_avg","constraint_matrix_abs_max",b"constraint_matrix_abs_max","constraint_matrix_abs_min",b"constraint_matrix_abs_min","constraint_matrix_col_min_l_inf_norm",b"constraint_matrix_col_min_l_inf_norm","constraint_matrix_num_nonzeros",b"constraint_matrix_num_nonzeros","constraint_matrix_row_min_l_inf_norm",b"constraint_matrix_row_min_l_inf_norm","num_constraints",b"num_constraints","num_variables",b"num_variables","objective_matrix_abs_avg",b"objective_matrix_abs_avg","objective_matrix_abs_max",b"objective_matrix_abs_max","objective_matrix_abs_min",b"objective_matrix_abs_min","objective_matrix_num_nonzeros",b"objective_matrix_num_nonzeros","objective_vector_abs_avg",b"objective_vector_abs_avg","objective_vector_abs_max",b"objective_vector_abs_max","objective_vector_abs_min",b"objective_vector_abs_min","objective_vector_l2_norm",b"objective_vector_l2_norm","variable_bound_gaps_avg",b"variable_bound_gaps_avg","variable_bound_gaps_max",b"variable_bound_gaps_max","variable_bound_gaps_min",b"variable_bound_gaps_min","variable_bound_gaps_num_finite",b"variable_bound_gaps_num_finite"]) -> builtins.bool: ...
...
class ConvergenceInformation(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        candidate_type: typing.Optional[global___PointType.ValueType] = ...,
        primal_objective: typing.Optional[builtins.float] = ...,
        dual_objective: typing.Optional[builtins.float] = ...,
        corrected_dual_objective: typing.Optional[builtins.float] = ...,
        l_inf_primal_residual: typing.Optional[builtins.float] = ...,
        l2_primal_residual: typing.Optional[builtins.float] = ...,
        l_inf_dual_residual: typing.Optional[builtins.float] = ...,
        l2_dual_residual: typing.Optional[builtins.float] = ...,
        l_inf_primal_variable: typing.Optional[builtins.float] = ...,
        l2_primal_variable: typing.Optional[builtins.float] = ...,
        l_inf_dual_variable: typing.Optional[builtins.float] = ...,
        l2_dual_variable: typing.Optional[builtins.float] = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["candidate_type",b"candidate_type","corrected_dual_objective",b"corrected_dual_objective","dual_objective",b"dual_objective","l2_dual_residual",b"l2_dual_residual","l2_dual_variable",b"l2_dual_variable","l2_primal_residual",b"l2_primal_residual","l2_primal_variable",b"l2_primal_variable","l_inf_dual_residual",b"l_inf_dual_residual","l_inf_dual_variable",b"l_inf_dual_variable","l_inf_primal_residual",b"l_inf_primal_residual","l_inf_primal_variable",b"l_inf_primal_variable","primal_objective",b"primal_objective"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["candidate_type",b"candidate_type","corrected_dual_objective",b"corrected_dual_objective","dual_objective",b"dual_objective","l2_dual_residual",b"l2_dual_residual","l2_dual_variable",b"l2_dual_variable","l2_primal_residual",b"l2_primal_residual","l2_primal_variable",b"l2_primal_variable","l_inf_dual_residual",b"l_inf_dual_residual","l_inf_dual_variable",b"l_inf_dual_variable","l_inf_primal_residual",b"l_inf_primal_residual","l_inf_primal_variable",b"l_inf_primal_variable","primal_objective",b"primal_objective"]) -> None: ...
...
class InfeasibilityInformation(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        max_primal_ray_infeasibility: typing.Optional[builtins.float] = ...,
        primal_ray_linear_objective: typing.Optional[builtins.float] = ...,
        primal_ray_quadratic_norm: typing.Optional[builtins.float] = ...,
        max_dual_ray_infeasibility: typing.Optional[builtins.float] = ...,
        dual_ray_objective: typing.Optional[builtins.float] = ...,
        candidate_type: typing.Optional[global___PointType.ValueType] = ...,
        ) -> None: ...
...
class PointMetadata(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        point_type: typing.Optional[global___PointType.ValueType] = ...,
        random_primal_projections: typing.Optional[typing.Iterable[builtins.float]] = ...,
        random_dual_projections: typing.Optional[typing.Iterable[builtins.float]] = ...,
        active_primal_variable_count: typing.Optional[builtins.int] = ...,
        active_dual_variable_count: typing.Optional[builtins.int] = ...,
        active_primal_variable_change: typing.Optional[builtins.int] = ...,
        active_dual_variable_change: typing.Optional[builtins.int] = ...,
        ) -> None: ...
...
class IterationStats(google.protobuf.message.Message):
    ...
    """
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    class MethodSpecificStatsEntry(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    METHOD_SPECIFIC_STATS_FIELD_NUMBER: builtins.int
    ...
    *after* the iteration. Therefore stats from iteration 0 are the stats at
    ...
    @property
    def method_specific_stats(self) -> google.protobuf.internal.containers.ScalarMap[typing.Text, builtins.float]: ...
    def __init__(self,
        *,
        iteration_number: typing.Optional[builtins.int] = ...,
        convergence_information: typing.Optional[typing.Iterable[global___ConvergenceInformation]] = ...,
        infeasibility_information: typing.Optional[typing.Iterable[global___InfeasibilityInformation]] = ...,
        point_metadata: typing.Optional[typing.Iterable[global___PointMetadata]] = ...,
        cumulative_kkt_matrix_passes: typing.Optional[builtins.float] = ...,
        cumulative_rejected_steps: typing.Optional[builtins.int] = ...,
        cumulative_time_sec: typing.Optional[builtins.float] = ...,
        restart_used: typing.Optional[global___RestartChoice.ValueType] = ...,
        step_size: typing.Optional[builtins.float] = ...,
        primal_weight: typing.Optional[builtins.float] = ...,
        method_specific_stats: typing.Optional[typing.Mapping[typing.Text, builtins.float]] = ...,
        ) -> None: ...
...
class SolveLog(google.protobuf.message.Message):
    ...
    termination_string: typing.Text
    ...
    def __init__(self,
        *,
        ...
        params: typing.Optional[ortools.pdlp.solvers_pb2.PrimalDualHybridGradientParams] = ...,
        termination_reason: typing.Optional[global___TerminationReason.ValueType] = ...,
        termination_string: typing.Optional[typing.Text] = ...,
        iteration_count: typing.Optional[builtins.int] = ...,
        preprocessing_time_sec: typing.Optional[builtins.float] = ...,
        solve_time_sec: typing.Optional[builtins.float] = ...,
        solution_stats: typing.Optional[global___IterationStats] = ...,
        solution_type: typing.Optional[global___PointType.ValueType] = ...,
        iteration_stats: typing.Optional[typing.Iterable[global___IterationStats]] = ...,
        original_problem_stats: typing.Optional[global___QuadraticProgramStats] = ...,
        preprocessed_problem_stats: typing.Optional[global___QuadraticProgramStats] = ...,
        ) -> None: ...
