...
class PrimalDualHybridGradientParams(google.protobuf.message.Message):
    ...
    @property
    def random_projection_seeds(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.float]:
    ...
    def __init__(self,
        *,
        ...
        random_projection_seeds: typing.Optional[typing.Iterable[builtins.float]] = ...,
